...
public abstract class UrineFluid extends FlowableFluid {

    @Override
    public Fluid getStill(){
        return ModFluids.STILL_URINE;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_URINE;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.URINE_BUCKET;
    }


    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.URINE_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
